...
namespace PizzaStore.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,OrderType,DriverOut,DriverIn,Price")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,OrderType,DriverOut,DriverIn,Price")] Order order)
        {
            if (id != order.ID)
            {
                return NotFound();
